...
export const CONTACT_STYLES = {
  ...
  panel: "w-[1200px] md:w-[1800px] p-8 border-2 border-cyan-400 bg-[#070b14] relative rounded-sm shadow-[0_0_40px_rgba(34,211,238,0.3)]",
  ...
  successCloseBtn: "mt-8 px-6 py-2 border-2 border-cyan-400 text-cyan-400 font-bold transition-all uppercase text-xs hover:bg-cyan-400 hover:text-white",
...
`,  textareaIcon: "text-slate-400 mr-3 mt-1 group-focus-within:text-cyan-400",
  ...
  submitBtn: "w-full bg-cyan-500 py-3 mt-2 text-white font-white uppercase tracking-[0.3em] transition-all flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(34,211,238,0.4)] hover:bg-cyan-400 disabled:opacity-50 disabled:cursor-not-allowed"
};